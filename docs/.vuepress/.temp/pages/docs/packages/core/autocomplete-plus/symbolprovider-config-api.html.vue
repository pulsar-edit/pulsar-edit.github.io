...
<p><img src="@source/docs/packages/core/autocomplete-plus/symbol-provider-notes.jpg" alt="symbol-provider-notes"></p>
...
<p><img src="@source/docs/packages/core/autocomplete-plus/scopename.png" alt="scopenames"></p>
